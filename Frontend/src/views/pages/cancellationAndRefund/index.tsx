...
const CancellationAndRefund = () => {
  return (
    <div className="bg-default-200 p-4">
      <h1>Return and Refund Policy</h1>
      <p>Last updated: January 07, 2025</p>
      <p>Thank you for shopping at nicknameportal.</p>
      <p>
      ...
      <ul>
        <li>
          <p>
            ...
            this Agreement) refers to nicknameportal.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a
              href="https://nicknameportal"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://nicknameportal
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: support@nicknameinfotech.com</p>
        </li>
        <li>
          <p>By phone number: 8270564998</p>
        </li>
      </ul>
      <p>
      ...
      <p>billing and product with box</p>
      <p>
