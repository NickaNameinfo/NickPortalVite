...
export const RelatedProducts = ({ item = null, key = null }) => {
  return (
    <>
      <Card
        isPressable
        ...
        <CardFooter className="p-0">
          <div className="grid grid-cols-1 w-full">
            ...
            <div className="w-full flex justify-between mt-3 mb-3">
              <p className="font-normal text-sm  Pricecolor">{item?.unitSize} Stocks</p>
              <p className="font-normal text-sm  TextMaincolor">Rs : {item?.price}</p>
            </div>
          </div>
        </CardFooter>
      </Card>
